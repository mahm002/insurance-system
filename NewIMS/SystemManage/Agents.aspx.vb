...
Partial Public Class Agents
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If IsHeadQuarter(BranchNo.Value) Then
            ...
            SqlDataSource2.SelectCommand = "select * from BranchInfo where left(BranchNo,2)='" & Left(Session("Branch"), 2) & "' and right(BranchNo,3)<>'000' and agent=1 order by BranchNo "
        ...
        Else
            SqlDataSource2.ConnectionString = Conn.ConnectionString
            SqlDataSource2.SelectCommand = "select * from BranchInfo where left(BranchNo,2)='" & Left(BranchNo.Value, 2) & "' and right(BranchNo,3)<>'000' and agent=1 order by BranchNo "
            SqlDataSource2.Select(DataSourceSelectArguments.Empty)
    ...
    Protected Sub MainGrid_ToolbarItemClick(source As Object, e As ASPxGridViewToolbarItemClickEventArgs)
        ...
        Select Case e.Item.Name
            Case "NewAgent"
                ...
                MainGrid.JSProperties("cpNewWindowUrl") = "../SystemManage/AgentForm.aspx?Branch=" + BranchNo.Value
        End Select
        ...
        Select Case e.ButtonID
            Case "Edit"
                ...
                If Page.IsCallback Then
                    ...
                    MainGrid.JSProperties("cpNewWindowUrl") = "../SystemManage/AgentForm.aspx?Branch=" + BranchNo.Value + "&Agent=" + Br
