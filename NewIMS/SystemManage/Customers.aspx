<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="Customers.aspx.vb" Inherits=".Customers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table dir="rtl" style="width: 100%;">
        <tr>
            <td>
                <dx:ASPxGridView ID="MainGrid" runat="server" AutoGenerateColumns="false" DataSourceID="SqlDataSource2" RightToLeft="True" KeyFieldName="CustNo"
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="CustNo" Visible="true" VisibleIndex="1" Caption="رقم الزبون" CellStyle-HorizontalAlign="Right" AllowTextTruncationInAdaptiveMode="true" MinWidth="150" Width="20%">
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="CustName" VisibleIndex="2" Caption="اسم الزبون" CellStyle-HorizontalAlign="Right" AllowTextTruncationInAdaptiveMode="true" MinWidth="150" Width="20%">
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="CustNameE" VisibleIndex="3" Caption="الاسم اللاتيني" CellStyle-HorizontalAlign="Right" AllowTextTruncationInAdaptiveMode="true" MinWidth="150" Width="20%">
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="TelNo" VisibleIndex="4" Caption="رقم الهاتف" CellStyle-HorizontalAlign="Right" AllowTextTruncationInAdaptiveMode="true" MinWidth="150" Width="20%">
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
