...
Public Class Customers
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        SqlDataSource2.SelectCommand = "select * from CustomerFile  order by CustNo"
    ...
    Protected Sub MainGrid_ToolbarItemClick(source As Object, e As ASPxGridViewToolbarItemClickEventArgs)
        ...
        Select Case e.Item.Name
            Case "NewAgent"
                ...
                MainGrid.JSProperties("cpResult") = "إضافة"
                MainGrid.JSProperties("cpSize") = 1100
                MainGrid.JSProperties("cpNewWindowUrl") = "../SystemManage/CustomersForm.aspx"
        End Select
    ...
    Private Sub MainGrid_CustomButtonCallback(sender As Object, e As ASPxGridViewCustomButtonCallbackEventArgs) Handles MainGrid.CustomButtonCallback
        Select Case e.ButtonID
            Case "Edit"
                Dim Br = MainGrid.GetRowValues(e.VisibleIndex, "CustNo").ToString()

                Dim logname = MainGrid.GetRowValues(e.VisibleIndex, "CustName").ToString().Trim 'ASPxGridView.GetRowValues(e.VisibleIndex, ASPxGridView.KeyFieldName)
                ...
                If Page.IsCallback Then
                    ...
                    MainGrid.JSProperties("cpNewWindowUrl") = "../SystemManage/CustomersForm.aspx?Cust=" + Br
