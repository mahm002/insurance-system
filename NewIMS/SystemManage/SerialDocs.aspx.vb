...
Public Class SerialDocs
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If IsHeadQuarter(Session("Branch")) Then
            Systems.DataSourceID = "SystemsDS"
        Else
            If IsBranch(Session("Branch")) Then
                Systems.DataSourceID = "SystemsDSB"
            Else
                Systems.DataSourceID = "SystemsDSA"
            End If
    ...
    Private Sub MainGrid_CustomButtonCallback(sender As Object, e As ASPxGridViewCustomButtonCallbackEventArgs) Handles MainGrid.CustomButtonCallback
        ...
        Select Case e.ButtonID
            ...
            Case "Distribute"
                ...
                Dim Br = Right(MainGrid.GetRowValues(MainGrid.FocusedRowIndex, "OrderNo").ToString(), 4)
    ...
    Protected Sub SqlDataSource_Updating(sender As Object, e As SqlDataSourceCommandEventArgs)
        If e.Command.Parameters(0).Value > e.Command.Parameters(1).Value Then
            Exit Sub
        Else
