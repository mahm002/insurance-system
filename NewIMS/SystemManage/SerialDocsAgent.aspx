<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="SerialDocsAgent.aspx.vb" Inherits="SerialDocsAgents" %>
        ...
        <tr>
            ...
            <td class="dxeICC" style="height: 50px">
                ...
                <dx:ASPxComboBox ID="Systems" runat="server" Width="285px" DropDownWidth="550"
                    DropDownStyle="DropDownList" DataSourceID="SystemsDS" ValueField="SerialBranch"
                ...
                <asp:SqlDataSource ID="SystemsDS" runat="server" ConnectionString="<%$ ConnectionStrings:IMS-DBConnectionString %>"
                    SelectCommand="SELECT BranchNo, SUBSYSNO, Rtrim(BranchName)+' - '+ Rtrim(SUBSYSNAME) As SerialBranch
                            FROM BranchInfo LEFT OUTER JOIN SUBSYSTEMS ON SUBSYSTEMS.Branch=BranchInfo.BranchNo AND SUBSYSNO IN ('01','OR') where SUBSYSTEMS.Branch=@Br">
                    <SelectParameters>
