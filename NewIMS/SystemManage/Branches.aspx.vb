...
Partial Public Class Branches
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        SqlDataSource2.SelectCommand = "select * from BranchInfo where agent=0 and right(BranchNo,3)='000' "
        SqlDataSource2.Select(DataSourceSelectArguments.Empty)
        'GridView1.DataBind()
        MainGrid.DataBind()
    End Sub

    'Protected Sub Insert_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles Insert.Click
    '    Response.Write("<script> window.open('../SystemManage/BranchForm.aspx','_new'); </script>")
    'End Sub
    ...
    '            Response.Write("<script> window.open('../SystemManage/BranchForm.aspx?Br=" & GridView1.SelectedRow.Cells(2).Text & "','_new'); </script>")
    '            'MsgBox1.confirm("! ”Ì „ «·€«¡«·ÿ·» —ﬁ„ :" & OrderNo.Text & " Â·  —Ìœ «·≈” „—«— ?", "delete_request")
    '    End Select
    'End Sub
    ...
    Protected Sub MainGrid_ToolbarItemClick(source As Object, e As ASPxGridViewToolbarItemClickEventArgs)
        ...
        Select Case e.Item.Name
            Case "NewBranch"
                ...
                MainGrid.JSProperties("cpNewWindowUrl") = "../SystemManage/BranchForm.aspx"
        End Select
        ...
        Select Case e.ButtonID
            Case "Edit"
                ...
                If Page.IsCallback Then
                    ...
                    MainGrid.JSProperties("cpNewWindowUrl") = "../SystemManage/BranchForm.aspx?Br=" + Br
