<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Receipt.aspx.vb" Inherits="Receipt" %>
                ...
                <PanelCollection>
                    <dx:PanelContent runat="server">
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td class="dx-al">المدفوع (القيمة) :</td>
                                <td class="style1" colspan="4">
                            ...
                            <tr>
                                ...
                                <td class="dx-al">
                                    <asp:Label
                                        ID="Label1" runat="server" Text="نوع التسوية: "></asp:Label>
                                </td>
                                <td class="style1">
                                    <dx:ASPxComboBox ID="PayTyp" runat="server"
                                        ...
                                        RightToLeft="True"
                                        SelectedIndex="0" DataSourceID="Pay">
                                        <ClientSideEvents ValueChanged="HideOrShow" />
                                        <%--SelectedIndexChanged="HideOrShow"--%>
                                        <%--<Items>
                                            <dx:ListEditItem Text="نقداً" Value="1" Selected="True" />
                                            <dx:ListEditItem Text="بصك" Value="2" />
                                            <dx:ListEditItem Text="بإشعار" Value="3" />
                                            <dx:ListEditItem Text="على الحساب" Value="4" />
                                            <dx:ListEditItem Text="بطاقة مصرفية" Value="5" />
                                        </Items>--%>
                                    </dx:ASPxComboBox>
                                </td>
                                <td class="style1">
                            ...
                            <tr>
                                ...
                                <td class="style1" colspan="4" rowspan="2">
