<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="Offices.aspx.vb" Inherits=".Offices" %>
        ...
        <tr>
            <td>
                ...
                <dx:ASPxGridView ID="MainGrid" runat="server" AutoGenerateColumns="false" DataSourceID="SqlDataSource2" RightToLeft="True" KeyFieldName="BranchNo"
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="BranchNo" Visible="true" VisibleIndex="1" Caption="رمز المكتب" CellStyle-HorizontalAlign="Right" AllowTextTruncationInAdaptiveMode="true" MinWidth="150" Width="20%">
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="BranchName" VisibleIndex="2" Caption="اسم المكتب" CellStyle-HorizontalAlign="Right" AllowTextTruncationInAdaptiveMode="true" MinWidth="150" Width="20%">
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                    ...
                    <Toolbars>
                        <dx:GridViewToolbar>
                            ...
                            <Items>
                                <dx:GridViewToolbarItem Command="Custom" Name="NewAgent" Text="مكتب جديد" Image-IconID="tasks_newtask_16x16" AdaptivePriority="2">
