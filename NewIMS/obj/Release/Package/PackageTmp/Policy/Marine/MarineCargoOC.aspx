<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="MarineCargoOC.aspx.vb" Inherits="MarineCargoOC" %>
                                    ...
                                    <table border="0" dir="rtl" style="width: 100%;">
                                        <tr>
                                            ...
                                            <td class="auto-style2">
                                                <dx:ASPxTextBox ID="Importer" runat="server" ClientInstanceName="Importer" CssClass="1" Width="110px">
                                            ...
                                            <td class="auto-style19">
                                                <dx:ASPxTextBox ID="ContractNo" runat="server" ClientInstanceName="ContractNo" CssClass="1" Width="110px">
                                                    <ClientSideEvents ValueChanged="Validate" />
                                                    <ValidationSettings SetFocusOnError="True" ValidationGroup="Data">
                                                        <RegularExpression ValidationExpression="^[A-Za-z0-9ا./-,يءئ \\-]+" />
                                                        <RequiredField IsRequired="True" />
                                        ...
                                        <tr>
                                            <td>رقم الفاتورة :</td>
                                            <td>
                                                <dx:ASPxTextBox ID="InvNo" runat="server" ClientInstanceName="InvNo" CssClass="1" Width="110px">
                                                    <ClientSideEvents ValueChanged="Validate" />
                                                    <ValidationSettings SetFocusOnError="True" ValidationGroup="Data">
                                                        <RegularExpression ValidationExpression="^[A-Za-z0-9ا./-,يءئ \\-]+" />
                                                        <RequiredField IsRequired="True" />
                                            ...
                                            <td>الكمية :</td>
                                            <td>
                                                <%--     <dx:ASPxTextBox ID="Quantity" runat="server" ClientInstanceName="Quantity" CssClass="3" Width="110px">
                                                ...
                                                <dx:ASPxTextBox ID="Quantity" runat="server" ClientInstanceName="Quantity" CssClass="1" Width="110px">
                                                    <ClientSideEvents ValueChanged="Validate" LostFocus="function(s, e) {
                                            ...
                                            <td>سعر الوحدة :</td>
                                            <td>
                                                <dx:ASPxTextBox ID="UnitPrice" runat="server" ClientInstanceName="UnitPrice" CssClass="2" Text="58.979" Width="109px">
                                                    <ClientSideEvents LostFocus="function(s, e) {
                                                                cbp.PerformCallback('SumInsCalc'); }" />
                                                    <ValidationSettings SetFocusOnError="True" ValidationGroup="Data">
                                                        <RegularExpression ErrorText="أرقام فقط" ValidationExpression="[-+]?[0-9]{0,3}\.?[0-9]{1,8}" />
                                                        <RequiredField IsRequired="True" />
                                                    </ValidationSettings>
                                                </dx:ASPxTextBox>
                                            </td>
                                        ...
                                        <tr>
                                            <td>رقم الاعتماد :</td>
                                            <td>
                                                <dx:ASPxTextBox ID="SurNo" runat="server" ClientInstanceName="SurNo" CssClass="1" Width="110px">
                                                    <ClientSideEvents ValueChanged="Validate" />
                                                    <ValidationSettings SetFocusOnError="True" ValidationGroup="Data">
                                                        <RegularExpression ValidationExpression="^[A-Za-z0-9ا./-,يءئ \\-]+" />
                                                        <RequiredField IsRequired="True" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dx:ASPxTextBox ID="DocVal" runat="server" ClientInstanceName="DocVal" CssClass="2" Text="0" Width="109px" DisplayFormatString="n3">
                                            ...
                                            <td>نوع العملة :</td>
                                            <td>
                                                <dx:ASPxComboBox ID="Currency" runat="server" ClientInstanceName="Currency" DataSourceID="Cur1" DropDownStyle="DropDown" RightToLeft="True" SelectedIndex="0" TextField="TpName" ValueField="TpNo" Width="110px">
                                        ...
                                        <tr>
                                            <td>مبلغ التأمين :</td>
                                            <td>
                                                <dx:ASPxTextBox ID="SumIns" runat="server" ClientInstanceName="SumIns" CssClass="2" Text="0" Width="109px" DisplayFormatString="n3">
                                                    <ClientSideEvents TextChanged="Validate" />
                                                    <ValidationSettings SetFocusOnError="True" ValidationGroup="Data">
                                                        <RegularExpression ErrorText="أرقام فقط" />
                                                        <RequiredField IsRequired="True" />
                                            ...
                                            <td>&nbsp;</td>
                                            <td>
                                                <dx:ASPxTextBox ID="NewSumIns" runat="server" ClientInstanceName="NewSumIns" CssClass="2" Text="0" Width="109px" ClientEnabled="false">
                                            ...
                                            <td class="auto-style19">هامش إضافي :</td>
                                            <td class="auto-style19">
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style2">ومنها إلى :</td>
                                            <td class="auto-style1">
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style2">نوع التعبئة :</td>
                                            <td class="auto-style1">
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style1" colspan="5">
                                                <dx:ASPxComboBox ID="InsCond" runat="server" ClientInstanceName="InsCond" DataSourceID="InsConds" DropDownStyle="DropDown" RightToLeft="True" SelectedIndex="0" TextField="TpName" ValueField="TpNo" Width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dx:ASPxButton ID="btnShow" runat="server" AutoPostBack="False" ClientInstanceName="btnShow" Text="تخزين">
                                                    <ClientSideEvents Click="function(s, e) {cbp.PerformCallback('Calc'); }" />
                                                </dx:ASPxButton>
                                            </td>
                                            <td>المسافة :</td>
                                            <td>
