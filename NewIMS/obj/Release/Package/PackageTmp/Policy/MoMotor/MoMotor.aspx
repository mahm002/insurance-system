<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MoMotor.aspx.vb" Inherits="MoMotor" %>
                                ...
                                <td class="dx-al">
                                    ...
                                    <table dir="rtl" style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style1">
                                                <dx:ASPxCheckBox ID="Burglary" runat="server" AccessibilityLabelText="" CheckState="Unchecked" RightToLeft="True" Text="تغطية السطو والسرقة باستعمال قوة السلاح (السرقة والسطو المسلح)">
                                                    <ValidationSettings ErrorTextPosition="Left">
                                                    </ValidationSettings>
                                                </dx:ASPxCheckBox>
                                            </td>
