<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MedicalRespMusa3eda.aspx.vb" Inherits="MedicalRespMusa3eda" %>
                            ...
                            <tr>
                                <td class="dx-al">
                                    ...
                                    <table border="0" dir="rtl" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td class="auto-style2">المؤهل العلمي :</td>
                                            <td class="auto-style2">
                                                <dx:ASPxTextBox ID="Education" runat="server" ClientInstanceName="Education" CssClass="1" Width="100%">
                                                    <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="Data">
                                            ...
                                            <td class="auto-style19">
                                                <dx:ASPxTextBox ID="Specialist" runat="server" ClientInstanceName="Specialist" CssClass="1" Width="100%">
                                                    <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="Data">
                                                        <RegularExpression ErrorText="حروف فقط" ValidationExpression="^[A-Za-z0-9ا-يءإؤةأئ /-\\-]+" />
                                                        <RequiredField IsRequired="True" />
                                                    </ValidationSettings>
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style2">إذن المزاولة :</td>
                                            <td class="auto-style19">
                                                <dx:ASPxTextBox ID="PermisionNo" runat="server" ClientInstanceName="PermisionNo" CssClass="1" Width="170px">
                                                    <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="Data">
