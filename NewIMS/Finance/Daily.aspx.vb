...
Public Class Daily
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim prntCheque = MainGrid.Toolbars(0).Items.FindByName("PrintCheques")

        Select Case Request("Sys")
            Case 4, 3
                prntCheque.Visible = True
            Case Else
                prntCheque.Visible = False
        End Select
    ...
    Protected Sub MainGrid_ToolbarItemClick(source As Object, e As ASPxGridViewToolbarItemClickEventArgs)
        Select Case e.Item.Name
            ...
            Case "PrintCheques"
                ...
                MainGrid.JSProperties("cpMyAttribute") = "PrintChequ"
                MainGrid.JSProperties("cpResult") = GetSysName(Sys.Value)
                MainGrid.JSProperties("cpNewWindowUrl") = "../Finance/PrintCheques.aspx"
            ...
            Case "BalanceSheet"
                ...
                'p(0) = New ReportParameter("DFrom", Format(Today.AddMonths(-1), "yyyy/MM/dd"), True)
                'p(1) = New ReportParameter("DTo", Format(Today.Date, "yyyy/MM/dd"), True)
                'p(2) = New ReportParameter("lvl", 20, True)
                'p(3) = New ReportParameter("B1", Session("Branch").ToString, IsHeadQuarter(Session("Branch")))
