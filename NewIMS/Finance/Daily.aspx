<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="Daily.aspx.vb" Inherits="Daily" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnEndCallback(s, e) {
            ...
            if (s.cpNewWindowUrl != null && s.cpMyAttribute == 'PrintChequ') {
                //window.open(s.cpNewWindowUrl);
                //PrintPop.SetSize(s.cpSize, 800);
                let hdr = s.cpResult
                let mhdr = 'طباعة صكوك '
        ...
        function IsCustomExportToolbarCommand(command) {
            return command == "NewDaily" || command == "ExtraSearch" || command == "BalanceSheet" || command == "MJournal" || command == "DJournal" || command =="PrintCheques";
        ...
        <PanelCollection>
            <dx:PanelContent runat="server">
                ...
                <dx:ASPxGridView ID="MainGrid" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource" RightToLeft="True"
                    ...
                    SettingsLoadingPanel-Text="تحميل..." Delay="3"
