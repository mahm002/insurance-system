...
Public Class MachinesImport
    ...
    Private Function GetTableFromExcel() As DataTable
        ...
        Dim unused = book.LoadDocument(FilePath)
    ...
    Protected Sub ASPxButton5_Click(sender As Object, e As EventArgs) Handles ASPxButton5.Click
        ...
        If Grid.VisibleColumns.Count <> 5 Then
            MsgBox("ERROR IN DATA")
        Else
            While Grid.VisibleRowCount > i
                'While Grid.VisibleColumns.Count > j
                ExecConn("insert into Machines(SubIns,OrderNo,EndNo,LoadNo,MacDetails,ChasisNo,BlateNo,MadeYear,SumIns,Rate,Premium) Values('" _
                              & Request("Sys") & "','" _
                              & Request("OrderNo") & "'," _
                              & Request("EndNo") & "," _
                              & 0 & ",'" _
                              ...
                              & Rate.Value & "," _
                              & Rate.Value / 100 * Grid.GetDataRow(i)(4) & ")", Conn)
                'j += 1
                'Grid.GetDataRow(i)(j)
                'End While
                'j = 1
