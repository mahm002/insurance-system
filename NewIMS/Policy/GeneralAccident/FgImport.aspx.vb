    ...
    Protected Sub ASPxButton5_Click(sender As Object, e As EventArgs) Handles ASPxButton5.Click
        ...
        Else
            While Grid.VisibleRowCount > i
                ...
                ExecConn("insert into FidilityGuarantee(SubIns,OrderNo,EndNo,LoadNo,Name,Title,JobType,JobPlace,SumIns,Rate,Premium) Values('" _
                              & Request("Sys") & "','" _
                              & Request("OrderNo") & "'," _
                              & Request("EndNo") & "," _
                              & Request("LoadNo") & ",'" _
                              ...
                              & Rate.Value & "," _
                              & (Rate.Value / 1000) * Grid.GetDataRow(i)(4) & ")", Conn)
                'j += 1
                'Grid.GetDataRow(i)(j)
                'End While
                'j = 1
