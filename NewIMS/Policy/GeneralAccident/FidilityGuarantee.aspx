<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FidilityGuarantee.aspx.vb" Inherits="FidilityGuarantee" %>
                            ...
                            <tr>
                                <td class="dx-al">
                                    ...
                                    <table dir="rtl" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td class="auto-style3">التحمل</td>
                                            ...
                                            <td colspan="3">
                                                <dx:ASPxGridView ID="DataGrid" ClientInstanceName="DataGrid" runat="server" DataSourceID="DataS"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="Title" ReadOnly="false" VisibleIndex="4" Caption="الصفة">
                                                            <EditFormSettings Visible="true" />
                                                        </dx:GridViewDataTextColumn>
                                                    ...
                                                    <SettingsText ConfirmDelete="سوف يتم شطب هذا الموظف، هل أنت متأكد؟" />
                                                ...
                                                <asp:SqlDataSource ID="DataS" runat="server" ConnectionString='<%$ ConnectionStrings:IMSDBConnectionString %>'
                                                    SelectCommand="SELECT OrderNo,EndNo,SerNo, Name, Title, JobType, JobPlace, SumIns, Premium, Rate FROM FidilityGuarantee WHERE ([OrderNo] = @Order) AND ([EndNo]=@End)"
                                                    DeleteCommand="DELETE FROM [FidilityGuarantee] WHERE [SerNo] = @SerNo"
                                                    InsertCommand="INSERT INTO [FidilityGuarantee] (OrderNo, EndNo, LoadNo, SubIns, Name, Title, JobType, JobPlace,SumIns,Premium,Rate)
                                                       VALUES (@Order,@End,[dbo].[GetLoadNo](@Order),@System ,@Name ,@Title, @JobType, @JobPlace, @SumIns,(@Rate/1000)*@SumIns,@Rate)"
                                                    UpdateCommand="UPDATE [FidilityGuarantee] SET [Name] = @Name, [Title] = @Title, [JobType] = @JobType , [JobPlace] = @JobPlace,
