...
Public Class ElImport
    ...
    Protected Sub ASPxButton5_Click(sender As Object, e As EventArgs) Handles ASPxButton5.Click
        ...
        If Grid.VisibleColumns.Count <> 7 Then
            MsgBox("ERROR IN DATA")
        Else
            While Grid.VisibleRowCount > i
                'While Grid.VisibleColumns.Count > j
                ExecConn("insert into EmployerLiability(SubIns,OrderNo,EndNo,LoadNo,Name,EmpCnt,JobType,JobPlace,SalarySum,BenfitSum,RespLimitPerPerson,RespLimit,Rate,Premium) Values('" _
                              & Request("Sys") & "','" _
                              & Request("OrderNo") & "'," _
                              & Request("EndNo") & "," _
                              & Request("LoadNo") & ",'" _
                              ...
                              & Grid.GetDataRow(i)(6) & "," _
                              & Grid.GetDataRow(i)(6) * Grid.GetDataRow(i)(1) & "," _
                              & Rate.Value & "," _
                              & (Rate.Value / 100) * (Grid.GetDataRow(i)(6) * Grid.GetDataRow(i)(1)) & ")", Conn)
                'j += 1
                'Grid.GetDataRow(i)(j)
                'End While
                'j = 1
