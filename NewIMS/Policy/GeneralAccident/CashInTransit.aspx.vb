            ...
            Select Case e.Parameter
                ...
                Case "Calc"
                    ...
                    If isValid Then
                        ...
                        Premium.Text = Format(((Rate.Value / 1000) * SumIns.Value) * diff, "0.000")
                        If GetDxTextValue(FindControlRecursive(PolicyControl, "EndNo")) = 0 Then
                            T = True
                            Premium.Text = Format(((Rate.Value / 1000) * SumIns.Value) * diff, "0.000")
                            SetDxtxtValue(FindControlRecursive(PolicyControl, "NETPRM"), Format(((Rate.Value / 1000) * SumIns.Value) * diff, "0.000"))
                        ...
                        Else
                            T = False
                            Premium.Text = Format(((Rate.Value / 1000) * SumIns.Value) * diff, "0.000") 'GetNet(GetEbaValue(PermType, 1), Val(Power.Text), Val(PassNo.Text), Val(Carry.Text))
