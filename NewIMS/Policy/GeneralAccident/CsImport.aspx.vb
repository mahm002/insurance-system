    ...
    Protected Sub ASPxButton5_Click(sender As Object, e As EventArgs) Handles ASPxButton5.Click
        ...
        Else
            While Grid.VisibleRowCount > i
                ...
                ExecConn("insert into CashInSafe(SubIns,OrderNo,EndNo,LoadNo,SafeType,SafePlaces,Size,SafeFix,SafeSecurity,CashIn,Body,Rate,Premium) Values('" _
                              & Request("Sys") & "','" _
                              & Request("OrderNo") & "'," _
                              & Request("EndNo") & "," _
                              & Request("LoadNo") & ",'" _
                              ...
                              & Rate.Value & "," _
                              & (Rate.Value / 100) * (Grid.GetDataRow(i)(5) + Grid.GetDataRow(i)(6)) & ")", Conn)
                'j += 1
                'Grid.GetDataRow(i)(j)
                'End While
                'j = 1
