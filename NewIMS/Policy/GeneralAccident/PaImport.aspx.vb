...
Public Class PaImport
    ...
    Protected Sub ASPxButton5_Click(sender As Object, e As EventArgs) Handles ASPxButton5.Click
        ...
        'If Grid.VisibleColumns.Count <> 6 Then
        '    MsgBox("ERROR IN DATA")
        'Else
        While Grid.VisibleRowCount > i
            'While Grid.VisibleColumns.Count > j
            ExecConn("insert into PersonalAccident (SubIns,OrderNo,EndNo,LoadNo,Name,Dob,IdentityID,Occupation,Nationality,SumIns,Rate,Premium) Values('" _
                              & Request("Sys") & "','" _
                              & Request("OrderNo") & "'," _
                              & Request("EndNo") & "," _
                              & Request("LoadNo") & ",'" _
                              & CStr(Trim(Grid.GetDataRow(i)(0))) & "','" _
                              & Format(CDate(Grid.GetDataRow(i)(1).ToString.Trim), "yyyy/MM/dd") & "','" _
                              & CStr(Trim(Grid.GetDataRow(i)(2))) & "','" _
                              & CStr(Trim(Grid.GetDataRow(i)(3))) & "','" _
                              & CStr(Trim(Grid.GetDataRow(i)(4))) & "'," _
                              & CDbl(Grid.GetDataRow(i)(5)) & "," _
                              & Rate.Value & "," _
                              & (Rate.Value / 100) * CDbl(Grid.GetDataRow(i)(5)) & ")", Conn)
