<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BurglaryImport.aspx.vb" Inherits="BurglaryImport" %>
    ...
    <form id="form1" runat="server">
        <div class="dxm-rtl">
            <table id="tbl" border="0" dir="rtl" style="width: 100%;">
                <tr>
                    <td colspan="3">
                        <dx:ASPxUploadControl runat="server" ShowProgressPanel="True" ShowUploadButton="True" RightToLeft="False" Width="100%" ID="Upload" BrowseButton-Text="استعراض" UploadButton-Text="تحميل" CancelButton-Text="إلغاء"
                ...
                <tr>
                    <td class="dx-al" colspan="3">
                        <a href="../../Templates/Burglary.xlsx" target="_blank">نموذج التحميل</a>
                    </td>
                </tr>
            </table>
