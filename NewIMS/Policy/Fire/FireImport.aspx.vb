    ...
    Protected Sub ASPxButton5_Click(sender As Object, e As EventArgs) Handles ASPxButton5.Click
        ...
        Else
            While Grid.VisibleRowCount > i
                ...
                ExecConn("insert into FireFile(SubIns,OrderNo,EndNo,LoadNo,InsItem,Area,BuildIns,BuildCont,ManBuildIns,ManBuildCont,BuildRate,ContRate,Premium) Values('" _
                              & Request("Sys") & "','" _
                              & Request("OrderNo") & "'," _
                              & Request("EndNo") & "," _
                              & Request("LoadNo") & ",'" _
                              ...
                              & Rate.Value & "," _
                              & Rate.Value & "," _
                              & (Rate.Value / 100) * (Grid.GetDataRow(i)(2) + Grid.GetDataRow(i)(3) + Grid.GetDataRow(i)(4) + Grid.GetDataRow(i)(5)) & ")", Conn)
                'j += 1
                'Grid.GetDataRow(i)(j)
                'End While
                'j = 1
