...
Public Class BurglaryImport
    ...
    Protected Sub ASPxButton5_Click(sender As Object, e As EventArgs) Handles ASPxButton5.Click
        ...
        If Grid.VisibleColumns.Count <> 4 Then
            MsgBox("ERROR IN DATA")
        Else
            While Grid.VisibleRowCount > i
                'While Grid.VisibleColumns.Count > j
                ExecConn("insert into FireFile(SubIns,OrderNo,EndNo,LoadNo,InsItem,Area,BuildCont,ManBuildCont,ContRate,Premium) Values('" _
                              & Request("Sys") & "','" _
                              & Request("OrderNo") & "'," _
                              & Request("EndNo") & "," _
                              & Request("LoadNo") & ",'" _
                              ...
                              & Rate.Value & "," _
                              & (Rate.Value / 100) * (Grid.GetDataRow(i)(2) + Grid.GetDataRow(i)(3)) & ")", Conn)
                'j += 1
                'Grid.GetDataRow(i)(j)
                'End While
                'j = 1
