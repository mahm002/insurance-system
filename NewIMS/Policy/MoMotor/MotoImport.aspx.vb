...
Public Class MotoImport
    ...
    Private Sub NewMethod(ByRef i As Integer, ByRef GRP As Integer)
        ...
        While Grid.VisibleRowCount > i
            ...
            ExecConn("insert into momotorfile(SubIns,OrderNo,EndNo,LoadNo,CarType,TableNo,BudyNo,PermType,CarColor,MadeYear,SumIns,Power,PassNo,Rate,Premium) Values('" _
                          & Request("Sys") & "','" _
                              & Request("OrderNo") & "'," _
                              & Request("EndNo") & "," _
                              & Request("LoadNo") & ",'" _
                              & Grid.GetDataRow(i)(0).ToString.Trim & "','" _
                              & Grid.GetDataRow(i)(1).ToString.Trim & "','" _
                              & Grid.GetDataRow(i)(2).ToString.Trim & "','" _
                              & Grid.GetDataRow(i)(3).ToString.Trim & "','" _
                              & Grid.GetDataRow(i)(4).ToString.Trim & "'," _
                              & Grid.GetDataRow(i)(5) & "," _
                              & CDbl(Grid.GetDataRow(i)(6)) & "," _
                              & Grid.GetDataRow(i)(7) & "," _
                              & Grid.GetDataRow(i)(8) & "," _
                              & Rate.Value & "," _
                              & (Rate.Value / 100) * CDbl(Grid.GetDataRow(i)(6)) & ")", Conn)
