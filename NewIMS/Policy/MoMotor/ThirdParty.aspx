<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ThirdParty.aspx.vb" Inherits="ThirdParty" %>
                            ...
                            <tr>
                                <td class="dx-al">
                                    <table dir="rtl" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td class="auto-style2">جهة الترخيص :</td>
                                            ...
                                            <td colspan="2" class="auto-style3">حدود المسؤولية :</td>
                                            <td class="auto-style3">
                                                <dx:ASPxTextBox ID="SumIns" runat="server" ClientInstanceName="SumIns" CssClass="2" ReadOnly="true" 
                                                    Text="10000" Width="200px" DisplayFormatString="n3" SelectInputTextOnClick="True">
                                                    <ClientSideEvents LostFocus="ValidateS" />
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <dx:ASPxTextBox ID="PermType" runat="server" ClientInstanceName="PermType" CssClass="1" Width="200px">
                                                    <ClientSideEvents LostFocus="ValidateS" />
                                                    <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="Data">
