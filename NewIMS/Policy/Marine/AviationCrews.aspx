<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AviationCrews.aspx.vb" Inherits="AviationCrews" %>
                            ...
                            <tr>
                                <td class="dx-al">
                                    ...
                                    <table dir="rtl" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td class="auto-style1">شروط&nbsp; التغطية</td>
                                        ...
                                        <tr>
                                            <td>
                                                <dx:ASPxHyperLink ID="Distribute" runat="server" ImageUrl="~/images/tasks.png" NavigateUrl="javascript:ShowScanPopup();" ToolTip="احتساب رسوم بيع النقد">
                                                </dx:ASPxHyperLink>
                                            </td>
                                            ...
                                            <td colspan="3">
                                                <dx:ASPxGridView ID="DataGrid" ClientInstanceName="DataGrid" runat="server" DataSourceID="DataS" RightToLeft="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataDateColumn FieldName="DateOfBirth" ReadOnly="false" VisibleIndex="4" Caption="تاريخ الميلاد" PropertiesDateEdit-DisplayFormatString="yyyy/MM/dd">
                                                            <PropertiesDateEdit DisplayFormatString="yyyy/MM/dd"></PropertiesDateEdit>

                                                            <EditFormSettings Visible="True" />
                                                        </dx:GridViewDataDateColumn>
                                                        <dx:GridViewDataTextColumn FieldName="Rank" ReadOnly="false" VisibleIndex="5" Caption="الوظيفة">
                                                            <EditFormSettings Visible="true" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="Nationality" ReadOnly="false" VisibleIndex="6" Caption="الجنسية">
                                                            <EditFormSettings Visible="true" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="SumIns" ReadOnly="false" VisibleIndex="7" Caption="مبلغ التأمين" PropertiesTextEdit-DisplayFormatString="n3">
                                                            <EditFormSettings Visible="true" />
                                                            <PropertiesTextEdit>
                                                                <ClientSideEvents ValueChanged="OnEditorValueChanged" />
                                                            </PropertiesTextEdit>
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="Rate" ReadOnly="false" VisibleIndex="8" Caption="السعر" PropertiesTextEdit-DisplayFormatString="n3">
                                                            <EditFormSettings Visible="true" />
                                                            <PropertiesTextEdit>
                                                                <ClientSideEvents ValueChanged="OnEditorValueChanged" />
                                                            </PropertiesTextEdit>
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="Premium" ReadOnly="true" VisibleIndex="9" Caption="القسط"
                                                    ...
                                                    <SettingsText ConfirmDelete="سوف يتم شطب هذا الشخص، هل أنت متأكد؟" />
                                                ...
                                                <asp:SqlDataSource ID="DataS" runat="server" ConnectionString='<%$ ConnectionStrings:IMSDBConnectionString %>'
                                                    SelectCommand="SELECT  OrderNo, EndNo, LoadNo, SubIns, GroupNo, Name, DateOfBirth, Rank, Nationality, SumIns, Rate, Premium, SerNo
                                                            FROM  AviationCrews WHERE ([OrderNo] = @Order) AND ([EndNo]=@End)"
                                                    DeleteCommand="DELETE FROM [AviationCrews] WHERE [SerNo] = @SerNo"
                                                    InsertCommand="INSERT INTO [AviationCrews] (OrderNo, Endno, LoadNo, SubIns, Name, DateOfBirth, Rank, Nationality, SumIns, Rate, Premium)
                                                       VALUES (@Order,@End,[dbo].[GetLoadNo](@Order), @System ,@Name ,@DateOfBirth, @Rank, @Nationality, @SumIns,@Rate,(@Rate/1000)*@SumIns)"
                                                    UpdateCommand="UPDATE [AviationCrews] SET [Name] = @Name, [DateOfBirth] = @DateOfBirth, [Rank] = @Rank , [Nationality] = @Nationality,
