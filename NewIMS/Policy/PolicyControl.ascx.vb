...
Public Class PolicyControl
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If IsBranch(Session("Branch")) Then
            ...
            OwnNo.ClientVisible = True
            CoverType.ClientVisible = True
            Currency.ClientVisible = IsHeadQuarter(Session("Branch"))
            ExcRate.ClientVisible = IsHeadQuarter(Session("Branch"))
            PayType.ClientVisible = IsHeadQuarter(Session("Branch"))
            AccountNo.ClientVisible = IsHeadQuarter(Session("Branch"))
        Else
            STMPRM.ClientEnabled = False
            ISSPRM.ClientEnabled = False
            OwnNo.ClientVisible = False
            CoverType.ClientVisible = False
            Currency.ClientVisible = False
            ExcRate.ClientVisible = False
            PayType.ClientVisible = False
            AccountNo.ClientVisible = False
        End If
        ...
        If IsBranch(Session("Branch")) Then
            Commissions.ClientVisible = True
            OwnNo.ClientVisible = True
        Else
            If IsBranchOffice(Session("Branch")) Then
                Commissions.ClientVisible = False
            Else
                Commissions.ClientVisible = False
            End If
            OwnNo.ClientVisible = False
        ...
        If Request("Sys") = "27" Then
            CustNameE.ClientVisible = False
            Commissions.ClientVisible = IsBranch(Session("Branch"))
            STMPRM.ClientEnabled = False
            ISSPRM.ClientEnabled = False
            OwnNo.ClientVisible = False
            CoverType.ClientVisible = True
            CoverType.ReadOnly = True
            Currency.ClientVisible = False
            ExcRate.ClientVisible = False
            PayType.ClientVisible = False
            AccountNo.ClientVisible = False
            ASPxLabel1.Text = "عدد الأيام"
            Measure.ClientVisible = False
        Else
            ASPxLabel1.Text = "المقياس"
        End If
    End Sub
            ...
            Else
                ...
                If endn = 0 Then
                    Select Case Request("Sys")
                        ...
                        Case "27"
                            If OrderNo.Text.TrimEnd = "0" Then
                ...
                Else
                    ...
                    Select Case Request("Sys")
                        Case "01"
                            If GetCoverFrom(Request("OrderNo"), Request("EndNo"), Request("Sys")) <= Today.Date Then
                                CoverFrom.Value = Today.Date
                            Else
                                CoverFrom.Value = GetCoverFrom(Request("OrderNo"), Request("EndNo"), Request("Sys"))
                            End If
            ...
            Select Case Request("Sys")
                Case "01"
                    ...
                    Else
                        ...
                        End Select
                    End If
                    If OrderNo.Value.ToString = "0" Then
                    Else
            ...
            Select Case Request("Sys")
                ...
                Case "27"
                    If OrderNo.Text = "0" Then
                        ...
                        Measure.ReadOnly = True
                        Interval.MinValue = 5
                        Interval.MaxValue = 1095
                        Interval.Value = IIf(Not Page.IsCallback, 5, Interval.Value)
