<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Mc1.aspx.vb" Inherits="Mc1" %>
...
<body>
    ...
    <div class="dx-ac">
        <dx:ASPxCallbackPanel ID="Callback" runat="server" ClientInstanceName="cbp" OnCallback="Callback_Callback" SettingsLoadingPanel-ShowImage="false">
                            ...
                            <td class="dx-al">
                                ...
                                <table dir="rtl" style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="dx-al">عدد الركاب :</td>
                                        <td>
                                            <dx:ASPxSpinEdit ID="PassNo" runat="server" ClientInstanceName="PassNo" MaxValue="100" Number="0" Width="110px" AutoPostBack="false"
                                                RightToLeft="True">
                                                <SpinButtons Position="left" ShowLargeIncrementButtons="True" />
                                                <ClientSideEvents NumberChanged="function(s, e) { OnChange(s, e); }" />
                                                <ValidationSettings ValidationGroup="Data" SetFocusOnError="True" Display="Dynamic">
                                                    <RequiredField IsRequired="True" />
                                                </ValidationSettings>
                                            </dx:ASPxSpinEdit>
                                    ...
                                    <tr>
                                        ...
                                        <td class="dx-al">
                                            <dx:ASPxSpinEdit ID="Power" runat="server" ClientInstanceName="Power" MaxValue="1000" Number="0" Width="110px" RightToLeft="True" AutoPostBack="false">
                                                <SpinButtons Position="left" ShowLargeIncrementButtons="True" />
                                               <%-- <ClientSideEvents ValueChanged="function(s, e) { OnChange(s, e); }" LostFocus="function(s, e) { OnChange(s, e); }" />--%>
                                                <ClientSideEvents NumberChanged="function(s, e) { OnChange(s, e); }" />
                                                <ValidationSettings ValidationGroup="Data" SetFocusOnError="True" Display="Dynamic">
                                                    <RequiredField IsRequired="True" />
                                                </ValidationSettings>
                                        ...
                                        <td class="dx-al">الحمولة بالطن :</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <dx:ASPxComboBox ID="PermType" runat="server" ClientInstanceName="PermType" DataSourceID="PermType1" SelectedIndex="0"
                                                DropDownStyle="DropDown" RightToLeft="True" TextField="TPName" ValueField="TPNo" Width="450px">
                                                <ClientSideEvents SelectedIndexChanged="function(s, e) { OnChange(s, e); }" />
                                                <ValidationSettings ValidationGroup="Data" Display="Dynamic">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="btnShow" runat="server" AutoPostBack="False" ClientInstanceName="btnShow" Text="تخزين" UseSubmitBehavior="false">
                                                <ClientSideEvents Click="function(s, e) { OnChange(s, e); }" />
                                            </dx:ASPxButton>
                                        </td>
